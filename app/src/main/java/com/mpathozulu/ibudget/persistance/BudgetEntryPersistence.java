...
import com.mpathozulu.ibudget.model.BudgetEntry;
...
public class BudgetEntryPersistence implements Persistence<BudgetEntry> {
    ...
    public BudgetEntryPersistence(Context context) {
